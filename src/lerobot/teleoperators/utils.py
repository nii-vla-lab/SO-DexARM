...
def make_teleoperator_from_config(config: TeleoperatorConfig) -> "Teleoperator":
    ...
    elif config.type == "quest_hts":
        from .quest_hts import QuestHTSTeleoperator

        return QuestHTSTeleoperator(config)
    elif config.type == "quest_hts_right":
        from .quest_hts import QuestHTSRightTeleoperator

        return QuestHTSRightTeleoperator(config)
    elif config.type == "quest_hts_dual_arm":
        from .quest_hts import QuestHTSDualArmTeleoperator

        return QuestHTSDualArmTeleoperator(config)
