...
class LeRobotDataset(torch.utils.data.Dataset):
    ...
    def save_episode(
        ...
        extra_episode_metadata: dict[str, object] | None = None,
    ) -> None:
        """
        ...
        Args:
            ...
            extra_episode_metadata (dict[str, object] | None, optional): Additional scalar metadata to
                store for this episode, such as teleoperation tracking status or robot fault details.
        """
